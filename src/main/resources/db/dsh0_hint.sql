...
Source Database       : dsh0

Target Server Type    : MYSQL
Target Server Version : 50720
File Encoding         : 65001

Date: 2020-07-10 15:53:08
*/
...
-- ----------------------------
-- Table structure for t_bussiness1
-- ----------------------------
DROP TABLE IF EXISTS `t_bussiness1`;
CREATE TABLE `t_bussiness1` (
...
-- ----------------------------
-- Records of t_bussiness1
-- ----------------------------
INSERT INTO `t_bussiness1` VALUES ('488352642046078976', 'xx', 'xx', 'xx', 'xx', '2020-06-23 00:00:00', '2020-06-23 00:00:00', '0', 'xx', '1');
INSERT INTO `t_bussiness1` VALUES ('488375049578328064', 'xx', 'xx', 'xx', 'xx', '2020-06-23 00:00:00', '2020-06-23 00:00:00', '0', 'xx', '1');

-- ----------------------------
-- Table structure for t_bussiness2
-- ----------------------------
DROP TABLE IF EXISTS `t_bussiness2`;
CREATE TABLE `t_bussiness2` (
  `id` bigint(20) NOT NULL COMMENT '主键',
  `name` varchar(64) DEFAULT NULL COMMENT '字段1',
  `code` varchar(64) DEFAULT NULL COMMENT '字段2',
  `addresscode` varchar(12) DEFAULT NULL COMMENT '地区编码',
...
-- ----------------------------
-- Records of t_bussiness2
-- ----------------------------
INSERT INTO `t_bussiness2` VALUES ('488352642046078976', 'xx', 'xx', 'xx', 'xx', '2020-06-23 00:00:00', '2020-06-23 00:00:00', '0', 'xx', '1');
