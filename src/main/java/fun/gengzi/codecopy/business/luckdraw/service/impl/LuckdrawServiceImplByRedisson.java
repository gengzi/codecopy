 ...
 */
@Service
public class LuckdrawServiceImplByRedisson implements LuckdrawService {
    private Logger logger = LoggerFactory.getLogger(LuckdrawServiceImplByRedisson.class);
