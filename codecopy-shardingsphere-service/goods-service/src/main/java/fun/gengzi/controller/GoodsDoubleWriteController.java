...
//
////    @Autowired
////    private GoodsOldJPA goodsOldJPA;
//
//
...
//
//        fun.gengzi.oldentity.GoodsEntity goodsEntity1 = new fun.gengzi.oldentity.GoodsEntity();
//        BeanUtils.copyProperties(good, goodsEntity1);
////        fun.gengzi.oldentity.GoodsEntity save1 = goodsOldJPA.save(goodsEntity1);
//
//
...
//     * @return
//     */
//    @ApiOperation(value = "查询商品分页信息（根据商品名称）-分库分表后，不再适用", notes = "查询商品分页信息（根据商品名称）")
